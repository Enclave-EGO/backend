...
router.get("/", jwtGuard, Roles(Role.TEACHER, Role.LEARNER), TestResultController.getTestResult);
router.post("/", jwtGuard, Roles(Role.TEACHER, Role.LEARNER), TestResultController.submitTest);
